...
[![Deploy with Vercel](https://vercel.com/button)](https://moveit-6t5fbv6p0-lealencar.vercel.app/)
...
```bash
$ git clone https://github.com/LeAlencar/moveit.git && cd moveit
```
...
[Move.it](https://moveit-6t5fbv6p0-lealencar.vercel.app/) came to remind you to exercise always! 💜
